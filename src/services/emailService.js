...
async function sendRegistrationEmail(userEmail, name){
    const subject = "Hello from project text! ";
...
async function sendTransactionEmail(userEmail, name, amount, toAccount){
    const subject = 'Transaction Succcesful';
    const text = `Hello ${name},\n\n Your transaction of ${amount} to account ${toAccount} was successful. \n\n Best regards, \n The Banking Transaction System Team`;
    const html = `<p>Hello ${name},</p> <p>Your transaction of ${amount} to account ${toAccount} was successful.</p> <p>Best regards, <br> The Banking Transaction System Team </p>`
    await sendEmail(userEmail, subject, text, html);
}
